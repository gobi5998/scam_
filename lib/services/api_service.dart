...
class ApiService {
  ...
  Future<Map<String, dynamic>?> getUserMe() async {
    try {
      ...
      if (response.data is Map<String, dynamic>) {
        ...
        print(
          "🖼️ All fields containing 'image': ${data.keys.where((key) => key.toLowerCase().contains('image')).toList()}",
        );
        print(
          "🖼️ All fields containing 'url': ${data.keys.where((key) => key.toLowerCase().contains('url')).toList()}",
        );
      }
  ...
  // Get due diligence files for a report
  ...
  Future<Map<String, dynamic>> resendVerificationEmail(String email) async {
    try {
      ...
      print(
        '✅ Resend verification email response status: ${response.statusCode}',
      );
