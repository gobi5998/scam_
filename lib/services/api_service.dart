...
//       if (filter.reportCategoryId != null &&
//           filter.reportCategoryId!.isNotEmpty) {
...
//         queryParams['reportCategoryId'] =
//             categoryIds.first; // Use first category
//       }
...
//         queryParams['alertLevels'] =
//             severityLevels.first; // Use first severity ID directly
//         print(
//           '🔍 API Service - Using severity level ID: ${severityLevels.first}',
//         );
//       }
...
//     try {
//       final response = await _dioService.get(
//         '${ApiConfig.reportsBaseUrl}/api/v1/thread-statistics',
//       );
//       if (response.statusCode == 200) {
...
//     try {
//       final response = await _dioService.get(
//         '${ApiConfig.reportsBaseUrl}/api/v1/percentage-count',
//       );
//       if (response.statusCode == 200) {
...
//     try {
//       final response = await _dioService.get(
//         '${ApiConfig.reportsBaseUrl}/api/v1/thread-analysis?range=$range',
//       );
//       if (response.statusCode == 200) {
//         return Map<String, dynamic>.from(response.data);
//       }
//       return {};
//     } catch (e) {
//       print('Error fetching thread analysis: $e');
//       return {};
//     }
//   }
// }
