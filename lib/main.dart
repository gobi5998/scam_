...
import 'models/offline_models.dart'; // Add offline models import
import 'services/offline_storage_service.dart'; // Add offline storage service import
import 'services/auto_sync_service.dart'; // Add auto sync service import
...
void main() async {
  ...
  // Register offline model adapters
  ...
  if (hasValidTokens) {
    print(
      '🔐 User has valid tokens, proceeding with authenticated operations...',
    );
    ...
    print('🔐 No valid tokens found, skipping authenticated operations...');
  }
