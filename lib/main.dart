...
void main() async {
  ...
  try {
    ...
    Hive.registerAdapter(OfflineSyncQueueAdapter());
    print('✅ Offline adapters registered');
    ...
    try {
      ...
      // Continue app startup even if offline storage fails
    }
  } catch (e) {
    print('❌ Critical error during app initialization: $e');
    // Don't let the app crash, continue with basic initialization
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // '/': (context) => const AuthGuard(child: DashboardPage()), // Removed to fix route conflict
